...
public class CameraFollow : MonoBehaviour {
    ...
    void MoveCam()
    {
        ...
        if (p.isConversing)
		{
			...
			if (stranger.transforming || stranger.aboutToBlow) {
				// ZOOM IN ON STRANGER TRANFORMING
				float distance = (stranger.revealed || stranger.blowingUp) ? 13f : 11f;
